...
- (void)buildView {
    ...
    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 79.5f, [UIScreen mainScreen].bounds.size.width, 0.5f)];
    ...
    self.button = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 80)];
...
- (void)buttonEvent {
    ...
    if (file.fileType == kFolder) {
        ...
        [self.controller.navigationController pushViewController:fileViewCV animated:YES];
    }
}
